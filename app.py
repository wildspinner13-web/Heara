...
def get_pexels_videos(query, page=1, per_page=20):
    ...
    try:
        ...
        with urllib.request.urlopen(
            ...
            print("PEXELS STATUS:", status_code)
        ...
        for video in data.get("videos", []):
            ...
            videos.append({
                ...
                "width": portrait_file.get(
                    "width"
                ),

                "height": portrait_file.get(
                    "height"
                ),
